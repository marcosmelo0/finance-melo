            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1, backgroundColor: colors.white }} keyboardShouldPersistTaps="handled">
                <Container>
                    ...
                    <Form>
                        <View>
                            <Label>Email</Label>
                            <Input placeholder='Digite seu email...' autoCapitalize="none" onChangeText={setEmail} />
                        </View>
                        <View>
                            <Label>Senha</Label>
                            <Input placeholder='Digite sua senha...' secureTextEntry autoCapitalize="none" onChangeText={setPassword} />
                        </View>
